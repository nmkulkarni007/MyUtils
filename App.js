...
import ModalDropdown from './src/util/ModalDropdown'
...
export default class App extends Component {
  ...
  render() {
    let dropdown_6_icon = this.state.dropdown_6_icon_heart ? 
    { uri: ('https://github.com/sohobloo/react-native-modal-dropdown/blob/master/example/images/heart.png') }: 
    { uri: ('https://github.com/sohobloo/react-native-modal-dropdown/blob/master/example/images/flower.png') };
    return (
